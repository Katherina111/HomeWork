...
/*
Создайте класс «Контейнер». В контейнер должны помещаться шары. В контейнере не должно быть одинаковых шаров (т.е. необходимо осуществлять проверку при добавлении шара на наличие его в контейнере). Контейнер должен включать следующие методы:
a. Добавление шара
b. Удаление шара
...
public class Conteiner {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(balls, conteiner.balls);
    }
